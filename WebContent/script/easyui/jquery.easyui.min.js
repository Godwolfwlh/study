...
},beforePageText:"当前页",afterPageText:"一共 {pages}页",displayMsg:"当前显示 {from} 到 {to}条; 一共 {total} 条&nbsp&nbsp&nbsp&nbsp",nav:{first:{iconCls:"pagination-first",handler:function(){
