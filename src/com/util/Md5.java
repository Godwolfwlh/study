 ...
 * @类描述：MD5 加密类
 * @创建人：panrz
 * @创建时间：2010-3-8 下午01:05:53
 * @修改人：panrz
 * @修改时间：2010-3-8 下午01:05:53
 * @修改备注：
 * @version
 */
public class Md5 {
...
/*	public String getMD5ofStr(String inbuf) {
	 ...
	 */
	public String getMD5ofStr(String inbuf) {
		//+"{1#2$3%4(5)6@7!poeeww$3%4(5)djjkkldss}"
		//+"{1#2$3%4(5)6@7!poeeww$3%4(5)djjkkldss}"
	...
	public static void main(String args[]) {
		System.out.println("20121101".substring(0,4)+"-"+"20121101".substring(4,6)+"-"+"20121101".substring(6,8));
		Md5 m = new Md5();
		if (Array.getLength(args) == 0) {

			System.out.println("MD5 Test suite:");
			System.out.println("MD5(\"\"):" + m.getMD5ofStr(""));
			System.out.println("MD5(\"\"):1111111" + m.getMD5ofStr("c4ca4238a0b923820dcc509a6f75849b"));
			System.out.println(m.getMD5ofStr("1"));
			System.out.println("MD5(\"\"):" + m.getMD5ofStr(""));
